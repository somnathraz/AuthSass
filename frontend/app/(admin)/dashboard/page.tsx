...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if (data?.me?.organizationId) {
      ...
      console.error(
        "User has no organization ID, staying on general dashboard"
      );
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="max-w-md w-full mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            <div className="w-16 h-16 mx-auto mb-4 bg-yellow-100 rounded-full flex items-center justify-center">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-4m-5 0H9m11 0a2 2 0 01-2 2H7a2 2 0 01-2-2m14 0V9a2 2 0 00-2-2M9 7h6m-6 4h6m-6 4h6m-6 4h6"
                />
              </svg>
            </div>
            <h1 className="text-xl font-semibold text-gray-900 mb-2">
            ...
            <p className="text-gray-600 mb-6">
              Your account doesn&apos;t have an associated organization. Please
              contact support.
            </p>
            <button
              onClick={() => router.push("/login")}
