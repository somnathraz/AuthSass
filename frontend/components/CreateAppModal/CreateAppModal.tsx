...
export function CreateAppModal({
  ...
  const { createApp, loading, error: createError } = useCreateApp(effectiveOrgId);
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.logoUrl && formData.logoUrl.trim() && !isValidUrl(formData.logoUrl)) {
      newErrors.logoUrl = "Please enter a valid URL";
    }

    if (formData.webhookUrl && formData.webhookUrl.trim() && !isValidUrl(formData.webhookUrl)) {
      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-hidden">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new application with comprehensive authentication and security settings
            </DialogDescription>
          </DialogHeader>
                ...
                <div className="max-h-[450px] overflow-y-auto">
                  <TabsContent value="general" className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <div className="flex space-x-2">
                            ...
                            <Button 
                              ...
                              onClick={() => {
                                const defaultIcons = [
                                  "https://ui-avatars.com/api/?name=" + encodeURIComponent(formData.name || "App") + "&background=4F46E5&color=fff&size=200",
                                  "https://api.dicebear.com/7.x/shapes/svg?seed=" + encodeURIComponent(formData.name || "app"),
                                ];
                                updateFormData({ logoUrl: defaultIcons[Math.floor(Math.random() * defaultIcons.length)] });
                              }}
                            >
                              Generate
                            </Button>
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-gray-500">One origin per line</p>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="auth" className="space-y-4">
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                      <div className="flex items-start space-x-2">
                        ...
                        <div>
                          <h4 className="font-medium text-blue-900 text-sm">Authentication Settings</h4>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <Label htmlFor="enableSignUp">Allow User Registration</Label>
                          <p className="text-xs text-gray-500">Allow new users to sign up</p>
                        </div>
                        <Switch 
                          id="enableSignUp"
                          checked={formData.enableSignUp}
                          onCheckedChange={(checked) => updateFormData({ enableSignUp: checked })}
                        />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-gray-500">Users must verify email before accessing app</p>
                        </div>
                        <Switch 
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <Label htmlFor="allowSocialLogins">Enable Social Logins</Label>
                          <p className="text-xs text-gray-500">Allow login with Google, GitHub, etc.</p>
                        </div>
                        <Switch 
                          id="allowSocialLogins"
                          checked={formData.allowSocialLogins}
                          onCheckedChange={(checked) => updateFormData({ allowSocialLogins: checked })}
                        />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch 
                          ...
                          onCheckedChange={(checked) => updateFormData({ enableMFA: checked })}
                        />
                      </div>

                      <div className="flex items-center justify-between">
                        <div>
                          <Label htmlFor="allowPasswordless">Allow Passwordless Login</Label>
                          <p className="text-xs text-gray-500">Enable magic links and email-only login</p>
                        </div>
                        <Switch 
                          id="allowPasswordless"
                          checked={formData.allowPasswordless}
                          onCheckedChange={(checked) => updateFormData({ allowPasswordless: checked })}
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => updateFormData({ sessionTimeout: parseInt(e.target.value) || 24 })}
                      />
                      <p className="text-xs text-gray-500">How long users stay logged in</p>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="security" className="space-y-4">
                    <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                      <div className="flex items-start space-x-2">
                        ...
                        <div>
                          <h4 className="font-medium text-red-900 text-sm">Security Features</h4>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-gray-500">Protect against abuse and DDoS</p>
                        </div>
                        <Switch 
                          id="enableRateLimit"
                          checked={formData.enableRateLimit}
                          onCheckedChange={(checked) => updateFormData({ enableRateLimit: checked })}
                        />
                      </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 ml-4">
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => updateFormData({ rateLimitRequests: parseInt(e.target.value) || 100 })}
                            />
                          </div>
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => updateFormData({ rateLimitWindow: parseInt(e.target.value) || 15 })}
                            />
                          </div>
                        </div>
                      )}
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <Label htmlFor="enableBruteForceProtection">Brute Force Protection</Label>
                          <p className="text-xs text-gray-500">Block repeated failed login attempts</p>
                        </div>
                        <Switch 
                          id="enableBruteForceProtection"
                          checked={formData.enableBruteForceProtection}
                          onCheckedChange={(checked) => updateFormData({ enableBruteForceProtection: checked })}
                        />
                      </div>
                    </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-2">
                          ...
                          <Select 
                            ...
                            onValueChange={(value) => updateFormData({ jwtAlgorithm: value })}
                          >
                            <SelectTrigger>
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                              <SelectItem value="RS256">RS256 (Recommended)</SelectItem>
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => updateFormData({ jwtExpiration: parseInt(e.target.value) || 24 })}
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  <TabsContent value="branding" className="space-y-4">
                    <div className="bg-purple-50 border border-purple-200 rounded-lg p-3">
                      <div className="flex items-start space-x-2">
                        ...
                        <div>
                          <h4 className="font-medium text-purple-900 text-sm">Brand Customization</h4>
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-gray-500">Custom CSS will be injected into auth pages</p>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="advanced" className="space-y-4">
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
                      <div className="flex items-start space-x-2">
                        ...
                        <div>
                          <h4 className="font-medium text-gray-900 text-sm">Advanced Features</h4>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-500">Receive real-time notifications for auth events</p>
                    </div>
                        ...
                        {[
                          ...
                          <div key={event.id} className="flex items-center space-x-2">
                            <input
                              type="checkbox"
                              id={event.id}
                              checked={formData.webhookEvents?.includes(event.id) || false}
                              onChange={(e) => {
                                const events = formData.webhookEvents || [];
                                if (e.target.checked) {
                                  updateFormData({ webhookEvents: [...events, event.id] });
                                } else {
                                  updateFormData({ webhookEvents: events.filter(ev => ev !== event.id) });
                                }
                              }}
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="allowedCallbacks">Allowed Callback URLs</Label>
                      <Textarea
                        id="allowedCallbacks"
                        ...
                        onChange={(e) => updateFormData({ 
                          allowedCallbacks: e.target.value.split('\n').filter(url => url.trim()) 
                        })}
                      />
                      <p className="text-xs text-gray-500">URLs where users are redirected after login</p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        onChange={(e) => updateFormData({ 
                          allowedLogouts: e.target.value.split('\n').filter(url => url.trim()) 
                        })}
                      />
                      <p className="text-xs text-gray-500">URLs where users are redirected after logout</p>
                    </div>
                  </TabsContent>
                </div>
              </Tabs>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-800 mt-1">
                        {createError.message || "Failed to create application. Please try again."}
                      </p>
                    </div>
                  </div>
                </div>
