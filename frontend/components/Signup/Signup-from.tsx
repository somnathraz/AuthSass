...
export function SignupForm({
  ...
  // Local error state to capture field-specific errors and general error
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        // Example parsing: this can be updated to more detailed error parsing.
        if (errMsg.toLowerCase().includes("username")) {
          fieldErrors.userName = errMsg;
