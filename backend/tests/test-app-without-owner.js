...
console.log('Testing app creation without owner details...');
...
const variables = {
  input: {
    name: "App Without Owner Test",
    description: "Testing app creation without owner details",
    type: "WEB",
