...
const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
  ...
  const appDescription = formData.get("appDescription")?.toString();
  ...
  try {
    const response = await createApp(appName, appDescription || "");
    console.log("Create App successful:", response.data.createApp);
